...
pp Package.create!(name: "Silver", price: 20, duration: 0, locations_creating_limit: 3, endpoints_creating_limit: 3, endpoint_groups_creating_limit: 3, users_creating_limit: 10)
pp Package.create!(name: "Gold", price: 40, duration: 1, locations_creating_limit: 5, endpoints_creating_limit: 5, endpoint_groups_creating_limit: 5, users_creating_limit: 15)
pp Package.create!(name: "Premium", price: 60, duration: 2, locations_creating_limit: 10, endpoints_creating_limit: 10, endpoint_groups_creating_limit: 10, users_creating_limit: 20)

Subscription.create!(package_id: 1, status: 2, company_id: 1)